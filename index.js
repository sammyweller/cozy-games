...
let allowedOrigins = ['http://localhost:8080', 'http://localhost:1234', 'https://sw-cozy-ca769a64fe57.herokuapp.com/games', 'https://cozygamer.netlify.app/', 'https://sw-cozy-ca769a64fe57.herokuapp.com'];
app.use(cors({
